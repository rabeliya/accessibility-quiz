...
function App() {
  ...
  const handleStart = useCallback((selectedCategory = 'all') => {
    setCategory(selectedCategory)
    setQuestions(selectQuestions(selectedCategory))
    setAnswers([])
    setScreen('quiz')
  }, [])
  ...
  const handleRetry = useCallback(() => setScreen('top'), [])
  const handleQuit = useCallback(() => setScreen('top'), [])
